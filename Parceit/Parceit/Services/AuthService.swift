...
final class AuthService {
    ...
    ///   - completion: A completion handler to pass back a bool and an error.
    ///   - Bool: wasRegistered - Determines if the user was registered and saved to the database correctly.
